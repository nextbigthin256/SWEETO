                ...
                <tr class="product-row-hover" style="border-bottom:1px solid #e2e8f0; transition:all 0.15s ease; ${isChecked ? 'background:#eff6ff;' : ''}">
                  ...
                  <td style="padding:14px 16px;">
                    <div style="display:flex; align-items:center; gap:12px;">
                      <img src="${p.image || './assets/sweetos_share.jpg'}" alt="${p.name}" style="width:44px; height:44px; border-radius:10px; object-fit:cover; border:1px solid #e2e8f0; flex-shrink:0;">
...
export function attachAdminProductsListeners(context, shadow) {
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      const imageUrl = imgUrlVal.value || './assets/sweetos_share.jpg';
