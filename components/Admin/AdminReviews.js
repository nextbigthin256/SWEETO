      ...
      <div class="table-wrapper">
        <table style="width:100%; border-collapse:collapse; text-align:left;">
          ...
          <tbody>
            ...
            ` : filtered.map(r => {
              const prod = rawProducts.find(p => p.id === r.productId) || { name: 'Storefront Experience', image: './assets/sweetos_share.jpg' };
              ...
              return `
                <tr style="border-bottom:1px solid #e2e8f0; background:${isSelected ? 'rgba(0,82,204,0.04)' : 'transparent'};">
                  ...
                  <td style="padding:14px 16px;">
                    <div style="display:flex; align-items:center; gap:10px;">
                      <img src="${prod.image || './assets/sweetos_share.jpg'}" alt="${prod.name}" style="width:38px; height:38px; border-radius:8px; object-fit:cover; border:1px solid #e2e8f0; flex-shrink:0;">
