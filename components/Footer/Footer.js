...
import { footerCSS } from './Footer.styles.js';

class Footer extends HTMLElement {
  constructor() {
    super();
    this.attachShadow({ mode: 'open' });
    loadStyles(this.shadowRoot, footerCSS);
  }
      ...
      <footer class="footer glass-panel">
        <div class="footer-container">
          ...
          <div class="footer-brand">
            ...
            <p class="brand-desc">${localStorage.getItem('SWEETOS_store_desc') || 'Boutique officielle d\'équipements tech, accessoires de bureau et composants haut de gamme.'}</p>
          </div>
